...
namespace PrivateLibrary.Models
{
    ...
    public partial class PrivateLibraryEntities1 : DbContext
    {
        public PrivateLibraryEntities1()
            : base("name=PrivateLibraryEntities1")
        {
        }
        ...
        public virtual DbSet<BookCorrect> BookCorrect { get; set; }
